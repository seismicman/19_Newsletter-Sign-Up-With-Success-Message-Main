...
Regarding the functionality of this challenge in react, I used two components: "Card" and "Thank_you". Also three usestate to manage email, error and suscribed. With the value of these parameters I used conditional rendering to control the elements and error messages.
